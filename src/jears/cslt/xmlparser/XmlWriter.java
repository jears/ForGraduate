...
{
	public static void writeXml(String query, String dirString) throws FileNotFoundException, IOException {
		 //创建文档
...
//        
        ...
        //把数据输出到xml中
        out.output(root, new FileOutputStream("变形金刚.xml"));//或者FileWriter
